...
public enum ErrorType {
    ...
    //Image
    INVALID_IMAGE_COUNT_FAILED(HttpStatus.BAD_REQUEST, "이미지는 8장에서 32장 사이여야 합니다.", LogLevel.INFO),

    //Title
    INVALID_TITLE_FAILED(HttpStatus.BAD_REQUEST,"제목 입력은 필수입니다.",LogLevel.INFO);
